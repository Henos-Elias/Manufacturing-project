...
public class Manufacturing {
    ...
    public static void main(String[] args){
        ...
        System.out.println("How many cups did you sell on the fifth day.");
        day5 =keyboard.nextInt();
        System.out.println("How many cups did you sell on the sixth day.");
        day6 =keyboard.nextInt();

        totalcups= day1+day2+day3+day4+day5+day6;

        System.out.println("How much did one of those cups cost?");
        costpercup = keyboard.nextDouble();

        salestotal=costpercup*totalcups;
        System.out.println("Your total sales cost is, " + salestotal + ".");
        profit = salestotal - overalltotal;
